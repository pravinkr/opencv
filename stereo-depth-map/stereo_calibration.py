...
if __name__ == '__main__':
    ...
    #Sample run script to run the program
    ...
    # args.left_dir = "./left_camera"
    # args.left_file = "Calibration_MatrixL.yaml"
    # args.left_prefix = "imageL_"

    # args.right_dir = "./right_camera"
    # args.right_file = "Calibration_MatrixR.yaml"
    # args.right_prefix = "imageR_"

    # args.image_format ="png"
    # args.square_size = 0.025
    # args.width = 8
    # args.height = 6
    # args.save_file = "Calibration_MatrixStereo.yaml"
